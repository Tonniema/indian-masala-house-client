...
const Review = () => {
    return (
        <div className='bg-[url("https://images.squarespace-cdn.com/content/v1/5fb43dd79d63ac327876d9d8/1659831123917-19QRZSXLHRBUNQMKJ021/top+view+of+flowers.jpg?format=2500w")]' >
            <div>
                <h2 className='text-center text-orange-500 text-4xl  py-6 '>Our Happy Clients...</h2>
            </div>
            <div className='flex gap-3 m-3 flex-col md:flex-row md:justify-evenly py-4'>

                <div className="card  hover:bg-gradient-to-r from-[#bcbaa9] to-[#e69f98]  shadow-xl py-8">
                    <figure><LazyLoad><img className='w-[90px] h-[81px] rounded-[500px] mt-4 ' src="https://img.freepik.com/free-photo/friendly-smiling-woman-looking-pleased-front_176420-20779.jpg?size=626&ext=jpg&ga=GA1.1.1436565612.1673088567&semt=sph" alt="Shoes" /></LazyLoad></figure>
                    <div className="card-body text-center">
                        <h2 className=" text-center md:text-lg text-orange-500">Lyana Sing</h2>
                ...
                <div className="card  hover:bg-gradient-to-r from-[#bcbaa9] to-[#e69f98] shadow-xl py-8">
                    <figure><LazyLoad><img className='w-[90px] h-[81px] rounded-[500px] mt-4' src="https://img.freepik.com/free-photo/business-concept-portrait-confident-young-businesswoman-keeping-arms-crossed-looking-camera-w_1258-104422.jpg?size=626&ext=jpg&ga=GA1.1.1436565612.1673088567&semt=sph" alt="Shoes" /></LazyLoad></figure>
                    <div className="card-body text-center">
                        <h2 className=" text-center md:text-lg text-orange-500">Geeta Devi</h2>
                ...
                <div className="card  hover:bg-gradient-to-r from-[#bcbaa9] to-[#e69f98] py-8 shadow-xl">
                    <figure><LazyLoad><img className='w-[90px] h-[81px] rounded-[500px] mt-4' src="https://img.freepik.com/free-photo/cheerful-young-caucasian-businessman_171337-727.jpg?size=626&ext=jpg&ga=GA1.1.1436565612.1673088567&semt=sph" alt="Shoes" /></LazyLoad></figure>
                    <div className="card-body text-center">
                        <h2 className=" text-center md:text-lg text-orange-500">Umesh Bhatt</h2>
