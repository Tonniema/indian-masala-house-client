                ...
                <div className='w-[60%] mx-auto'>
                    <form onSubmit={Handle_Submit} className='bg-white' action="">
                        ...
                        <div className='w-[80%] mx-auto pt-3'>
                            <p className='md:text-[1.2em] text-[.85em] font-semibold'>Your Name</p>
                        ...
                        <div className='w-[80%] mx-auto pt-3'>
                            <p className='md:text-[1.2em] text-[.85em] font-semibold'>Photo URL</p>
                        ...
                        <div className='w-[80%] mx-auto pt-3'>
                            <p className='md:text-[1.2em] text-[.85em] font-semibold'>Your Email</p>
                        ...
                        <div className='w-[80%] mx-auto pt-3'>
                            <p className='md:text-[1.2em] text-[.85em] font-semibold'>Your Password</p>
                            <p className='pt-1 md:pt-2'><input name='password' id="password" type='password' required="required" placeholder='Enter your Password' className=" bg-[#f3f3f3] w-full py-2 md:py-4 pl-1 md:pl-2 text-[.65em] md:text-[.85em]" /></p>
                        </div>
